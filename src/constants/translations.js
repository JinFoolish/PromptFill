...
export const TRANSLATIONS = {
  cn: {
    ...
    switch_ui_language: "切换中英文界面",
    chinese: "中文",
    english: "English",
    ai_image_generation_config: "AI 图像生成",
    configure_api_keys_models: "配置 API Key 与模型参数",
    storage_location: "数据存储",
    browser_storage: "浏览器存储",
    fast_simplified_storage: "数据仅保存在当前浏览器",
    local_directory: "本地文件夹",
    sync_local_filesystem: "读写本地 JSON 文件",
    import_json: "导入数据",
    restore_from_backup: "从备份文件恢复模版",
    export_all: "全量导出",
    backup_all_templates: "备份所有模版与设置",
    reset_defaults: "重置预设",
    clear_all_data: "清空数据",
    about: "关于",
    changelog: "更新日志",
    ...
    built_for_creators: "Prompt Fill 为创作者而生。所有数据均保存在本地，我们不会上传您的任何内容。",
    scan_to_connect: "扫码添加作者微信",
    timeline_changes_improvements: "Timeline of changes & improvements",
  },
  en: {
    ...
    switch_ui_language: "Switch UI Language",
    chinese: "中文",
    english: "English",
    ai_image_generation_config: "AI Image Generation",
    configure_api_keys_models: "Configure API Keys & Models",
    storage_location: "Storage Location",
    browser_storage: "Browser Storage",
    fast_simplified_storage: "Fast, simplified storage",
    local_directory: "Local Directory",
    sync_local_filesystem: "Sync with local file system",
    import_json: "Import JSON",
    restore_from_backup: "Restore from backup",
    export_all: "Export All",
    backup_all_templates: "Backup all templates",
    ...
    github: "GitHub",
    open_source_repository: "Open Source Repository",
    built_for_creators: "Built for creators. All data stays local; we never upload your prompts.",
